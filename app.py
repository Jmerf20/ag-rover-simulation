...
# Polish layout styling using standardized Plotly properties
fig.update_layout(
    title=dict(
    ...
    xaxis=dict(
        title=dict(text="Added Cargo Payload Weight (lbs)", font=dict(color='#94A3B8')),
        tickfont=dict(color='#cbd5e1'),
        gridcolor='#334155',
        zerolinecolor='#475569'
    ),
    yaxis=dict(
        title=dict(text="Continuous Mission Runtime (Hours)", font=dict(color='#94A3B8')),
        tickfont=dict(color='#cbd5e1'),
        gridcolor='#334155',
        zerolinecolor='#475569',
        range=[0, 24]
